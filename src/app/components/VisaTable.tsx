    ...
    <div style={{ backgroundColor: '#fff' }} className='w-full'>
      ...
      {apiData.map((entry: any, index: number) => (
        ...
        <div className='card-body'>
          <div className='w-full mt-10' style={{
            borderRadius: 20, borderColor: '#f5f5f5',
            boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)',
          }}>
            <div style={{ backgroundColor: '#0095E8', width: '100%', height: 60, borderTopRightRadius: 20, borderTopLeftRadius: 20, paddingLeft: 20, alignItems: 'center', display: 'flex' }}>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <span className='text-dark fw-medium text-hover-primary d-block fs-30'>
                          <a href='javascript:void(0);' onClick={() => setExpandedCardIndex(expandedCardIndex === index ? -1 : index)}>View Here</a>
                        </span>
                        {expandedCardIndex === index && (
                          <div style={{
                            position: 'absolute', backgroundColor: 'white', width: 320, marginTop: 15, marginLeft: -100,
                            ...
                            <div className='d-flex w-full justify-content-between'>
                              <h4 className='mx-3 mt-3'>Documents
                              </h4>
                      ...
                      <td>
                        ...
                        <span className='text-dark fw-medium text-hover-primary d-block fs-30'>
                          ...
                          <InfoIcon style={{ marginLeft: 5 }} onClick={() => setPriceCardIndex(priceCardIndex === index ? -1 : index)} />
                          </a>
                        </span>
                        {priceCardIndex === index && (
                          <div style={{
                            position: 'absolute', backgroundColor: 'white', width: 220, marginTop: 15, marginLeft: -100,
                            borderRadius: 10, borderColor: '#f5f5f5',
                            boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)',
                            paddingLeft: 10,
                            paddingTop: 5
                            ...
                            {entry.receipt['Visa Fees'] &&
                              <h6>
                                Visa Fees : {entry.receipt['Visa Fees']}
                              </h6>
                            }
                            <hr />
                            {entry.receipt['Service Fees'] &&
                              <h6>
                                Service Fees : {entry.receipt['Service Fees']}
                              </h6>
                            }
