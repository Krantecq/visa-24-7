...
const ApplyVisa: React.FC<Props> = ({show,visaList}) => {
  ...
  return (
    <div>
      <h1 className='px-9' style={{marginTop:15}}>Get a visa to</h1>
      <Formik validationSchema={null} initialValues={initValues} onSubmit={onSubmit}>
        <Form className='py-5 w-100 px-9' noValidate id='kt_create_account_form'>
          ...
          <button onClick={() => show(true)} className='btn btn-primary'>Search</button>
          </div>
}
        </Form>
      </Formik>
