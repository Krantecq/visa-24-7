                            ...
                            <div className='d-flex'>
                                <div className='fv-row mb-10'>
                                    ...
                                    <Field
                                        ...
                                        onChange={(e) => handleProfileFieldChange('merchant_phone_number', e.target.value)}
                                        className='form-control form-control-lg form-control-solid'
                                    />
                                    <div className='text-danger mt-2'>
                            ...
                            <div className='d-flex'>
                                <div className='fv-row mb-5'>
                                    ...
                                    <Field
                                        ...
                                        onChange={(e) => handleProfileFieldChange('merchant_address_one_line', e.target.value)}
                                        className='form-control form-control-lg form-control-solid '
                                    />
                                    <div className='text-danger mt-2'>
                            ...
                            <div className='d-flex'>
                                <div className='fv-row mb-10'>
                                    ...
                                    <Field
                                        ...
                                        onChange={(e) => handleProfileFieldChange('merchant_address_second_line', e.target.value)}
                                        className='form-control form-control-lg form-control-solid '
                                    />
                                    <div className='text-danger mt-2'>
