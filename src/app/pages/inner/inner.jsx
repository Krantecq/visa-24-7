...
const Inner = () => {
    ...
    const [selectedTicket, setSelectedTicket] = useState(2);
    ...
    const updateUI = () => {
        document.querySelectorAll('.ticket').forEach((ticket) => {
            ...
            const daysElement = ticket.querySelector('.days');
            const visaDesElement = ticket.querySelector('.visa-des');
    
            daysElement.style.backgroundColor = '';
            daysElement.style.transition = 'background-color 0.5s ease';
    
            ticket.querySelector('.days, span').style.color = '';
            visaDesElement.style.border = '';
            visaDesElement.classList.remove('pulsate');
        });
    
        const selectedTicketElement = document.querySelector(`.ticket${selectedTicket}`);
        if (selectedTicketElement) {
            selectedTicketElement.classList.add('selected');
            const daysElement = selectedTicketElement.querySelector('.days');
            const visaDesElement = selectedTicketElement.querySelector('.visa-des');
    
            daysElement.style.backgroundColor = '#327113';
            daysElement.style.transition = 'background-color 0.5s ease';
    
            selectedTicketElement.querySelector('.days, span').style.color = '#fff';
            visaDesElement.style.border = '4px solid #327113';
            visaDesElement.classList.add('pulsate');
        }
    };
  ...
  return (
    <div>
        ...
        <div className="choice-maini">
            ...
            <div class="ticket-conti6" id="ticketconti6">
                    <div className={`ticket ticket${1}`} onClick={() => handleSelect(1)}>
                        
                        <div class="days">
                            <h1 class="days-size">30 </h1>
                            <span>Days</span>
                        </div>
                        <div class="ticket-area">
                            <div class="visa-type">TOURIST VISA &nbsp;
                    ...
                    <div className={`ticket ticket${2}`} onClick={() => handleSelect(2)}>
                        
                        <div class="days">
                            <h1 class="days-size">60 </h1>
                            <span>Days</span>
                        </div>
                        <div class="ticket-area">
                            <div class="visa-type">TOURIST VISA &nbsp;
                    ...
                    <div className={`ticket ticket${3}`} onClick={() => handleSelect(3)}>
                        <div class="days">
                            <h1 class="days-size">90 </h1>
                            <span>Days</span>
                        </div>
                        <div class="ticket-area">
                            <div class="visa-type">TOURIST VISA &nbsp;
